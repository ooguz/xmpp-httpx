...
- Body transports: inline `text` / `xml` / `base64`, `chunkedBase64` message streams, and **IBB** ([XEP-0047](https://xmpp.org/extensions/xep-0047.html), implemented here — no upstream xmpp.js package exists)
- SHIM headers ([XEP-0131](https://xmpp.org/extensions/xep-0131.html)), `httpx://` URL parsing, service discovery ([XEP-0030](https://xmpp.org/extensions/xep-0030.html))
...
- `sipub` (XEP-0137) and Jingle transports are **not** implemented yet; they decode cleanly and are answered with HTTP 501
